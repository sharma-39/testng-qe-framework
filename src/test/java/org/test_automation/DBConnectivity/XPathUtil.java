...
import org.test_automation.LabFlow.LabFlow;
...
public class XPathUtil {
     ...
     * @param wait
     */
    public void selectField(String identifier, String value, LabFlow.DropdownType type, String formId, WebDriver driver, WebDriverWait wait) {
        try {
            switch (type) {
                case STANDARD:
