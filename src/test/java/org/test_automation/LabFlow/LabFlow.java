...
public class LabFlow extends LoginAndLocationTest {
    ...
    private final Boolean labMasterflag = true;
            ...
            if (isAppointmentCreated) {
                ...
                if (isAppointmentCheckedIn) {
                    ...
                    if (patientRow != null) {
                        ...
                        WebElement inputField = driver.findElement(By.xpath("//td[@class='tbody1-al']//input[@type='text']"));

// 2. Type into the input field to trigger autocomplete
